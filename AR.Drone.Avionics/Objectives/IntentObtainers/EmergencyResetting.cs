...
namespace AR.Drone.Avionics.Objectives.IntentObtainers
{
    ...
    {
        public EmergencyResetting(bool aCanBeOntained = false) : base(0.0f, Intent.DefaultAgression, aCanBeOntained) { /* Do Nothing */ }

        public override void Contribute(Apparatus.Output aApparatusOutput, ref Apparatus.Input aApparatusInput)
        {
            aApparatusInput.Command = Apparatus.Input.Type.ResetEmergency;
            Obtained = true;
        }
    }
}
